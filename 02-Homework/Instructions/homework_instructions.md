...
1. Create a GitHub repo for this assignment and clone it to your computer. Any name will do -- just make sure it's related to this project in some fashion.
  ...
  * Be sure to use the Unsolved folder provided as a guideline for organizing your code structure.

  * You don't need to write the web-scraping code from scratch. You'll see it provided in scripts/scrape.js. You WILL need to create the route handler that calls the script, and then passes back the response.
